...
use windows::{Win32::{Foundation::{GENERIC_ALL, HANDLE}, Storage::FileSystem::{CreateFileW, FILE_ATTRIBUTE_SYSTEM, FILE_SHARE_NONE, OPEN_EXISTING}, System::Threading::Sleep}, core::PCWSTR};
